...
class Html
{
    ...
    public static function iconSvg(string $name): string
    {
        $paths = [
            ...
            'paperclip' => '<path d="m16 6-8.5 8.5a3.54 3.54 0 0 0 5 5L21 11a5 5 0 0 0-7-7l-9 9a6.5 6.5 0 0 0 9 9l8.5-8.5"/>',
