...
final class AdminAssistantService
{
    ...
    private function knowledge(): string
    {
        return implode("\n", [
            ...
            '• Настройки → Sitemap (/settings) проверява броя активни страници, категории и продукти и чрез „Генерирай sitemap“ записва предварително готовата карта. Картата не се генерира при всяко посещение на sitemap.xml.',
