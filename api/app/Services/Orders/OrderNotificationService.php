...
class OrderNotificationService
{
    ...
    {
        $paidByCashOnDelivery = $order->payment_method === 'cash_on_delivery';
        $messages = [
            ...
            'paid' => ['Плащането по поръчката е потвърдено', $paidByCashOnDelivery ? 'Поръчката е отбелязана като платена. При наложен платеж това може да означава, че пратката вече е получена и сумата е отчетена към магазина.' : 'Поръчката е отбелязана като платена и плащането е успешно отчетено към магазина.', $paidByCashOnDelivery ? 'Ако имате въпроси относно доставката или плащането, свържете се с нас.' : 'Ще Ви уведомим при следваща промяна на статуса.'],
