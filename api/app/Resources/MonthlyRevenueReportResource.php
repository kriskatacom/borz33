...
class MonthlyRevenueReportResource
{
    public static function toArray(MonthlyRevenueReport $report): array
    {
        return [
            ...
            'orders_count' => (int) $report->orders_count, 'delivered_orders_count' => (int) $report->delivered_orders_count, 'cancelled_orders_count' => (int) $report->cancelled_orders_count, 'items_sold' => (int) $report->items_sold,
            'gross_turnover' => $report->gross_turnover, 'recognized_revenue' => $report->recognized_revenue, 'product_revenue' => $report->product_revenue, 'shipping_revenue' => $report->shipping_revenue, 'average_order_value' => $report->average_order_value,
