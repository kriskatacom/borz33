...
export type SiteSettings = { logo_media_file_id: number | null; logo: MediaFile | null; admin_background: string | null; admin_background_overlay: number; vat_enabled: boolean; free_shipping_threshold: number; low_stock_threshold: number; econt_operations_enabled: boolean; econt: EcontSettings };
...
export function updateSiteSettings(token: string, body: { logo_media_file_id?: number | null; admin_background?: string | null; admin_background_overlay?: number; vat_enabled?: boolean; free_shipping_threshold?: number; low_stock_threshold?: number; econt_operations_enabled?: boolean; econt_environment?: 'demo' | 'production'; econt_production_username?: string; econt_production_password?: string }) {
