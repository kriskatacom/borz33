...
export type MonthlyRevenueReport = {
  ...
  orders_count: number; delivered_orders_count: number; cancelled_orders_count: number; items_sold: number;
  gross_turnover: string; recognized_revenue: string; product_revenue: string; shipping_revenue: string; average_order_value: string;
